...
export const API_WEBSOCKET_URL = import.meta.env.API_WEBSOCKET_URL
...
export const AUTH_INTERNAL_ORGANIZATION_ID = import.meta.env.AUTH_INTERNAL_ORGANIZATION_ID
...
export function logBuildInformation(): void {
  ...
  function logRow(label: string, value: string): void {
    LoggerUtil.info(`%c${label.padEnd(15)} %c${value}`, 'font-weight: bold;', 'font-weight: normal;')
  }
