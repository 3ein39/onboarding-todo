...
export type GetTodosV1Error = GetTodosV1Errors[keyof GetTodosV1Errors];

export type GetTodosV1Responses = {
    200: GetTodosResponse;
};

export type GetTodosV1Response = GetTodosV1Responses[keyof GetTodosV1Responses];

export type CreateTodoV1Data = {
...
export type CreateTodoV1Errors = {
    500: {
        traceId?: string | null;
        errors?: Array<InternalServerApiError>;
    };
...
export type CreateTodoV1Error = CreateTodoV1Errors[keyof CreateTodoV1Errors];

export type CreateTodoV1Responses = {
    201: CreateTodoResponse;
};

export type CreateTodoV1Response = CreateTodoV1Responses[keyof CreateTodoV1Responses];

export type DeleteTodoV1Data = {
    body?: never;
    path: {
        todoUuid: string;
    };
...
export type DeleteTodoV1Errors = {
    500: {
        traceId?: string | null;
        errors?: Array<InternalServerApiError>;
    };
...
export type DeleteTodoV1Error = DeleteTodoV1Errors[keyof DeleteTodoV1Errors];

export type DeleteTodoV1Responses = {
    200: unknown;
};

export type GetTodosV12Data = {
    body?: never;
    path: {
        todoUuid: string;
    };
...
export type GetTodosV12Error = GetTodosV12Errors[keyof GetTodosV12Errors];

export type GetTodosV12Responses = {
    200: GetTodoResponse;
};

export type GetTodosV12Response = GetTodosV12Responses[keyof GetTodosV12Responses];

export type UpdateTodoV1Data = {
...
export type UpdateTodoV1Errors = {
    500: {
        traceId?: string | null;
        errors?: Array<InternalServerApiError>;
    };
...
export type UpdateTodoV1Error = UpdateTodoV1Errors[keyof UpdateTodoV1Errors];

export type UpdateTodoV1Responses = {
    200: unknown;
};

export type CheckTodoV1Data = {
    body?: never;
    path: {
        todoUuid: string;
    };
...
export type CheckTodoV1Error = CheckTodoV1Errors[keyof CheckTodoV1Errors];

export type CheckTodoV1Responses = {
    200: unknown;
};

export type UncheckTodoV1Data = {
    body?: never;
    path: {
        todoUuid: string;
    };
...
export type UncheckTodoV1Errors = {
    500: {
        traceId?: string | null;
        errors?: Array<InternalServerApiError>;
    };
...
export type UncheckTodoV1Error = UncheckTodoV1Errors[keyof UncheckTodoV1Errors];

export type UncheckTodoV1Responses = {
    200: unknown;
};
