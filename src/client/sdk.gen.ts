...
export const setUserRolesV1 = <ThrowOnError extends boolean = true>(options: Options<SetUserRolesV1Data, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<SetUserRolesV1Responses, SetUserRolesV1Errors, ThrowOnError>({
        requestValidator: async (data) => {
...
export const getTodosV1 = <ThrowOnError extends boolean = true>(options?: Options<GetTodosV1Data, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetTodosV1Responses, GetTodosV1Errors, ThrowOnError>({
        requestValidator: async (data) => {
            return await zGetTodosV1Data.parseAsync(data);
        },
        responseValidator: async (data) => {
            return await zGetTodosV1Response.parseAsync(data);
        },
        url: '/api/v1/todos',
        ...options
    });
...
export const createTodoV1 = <ThrowOnError extends boolean = true>(options: Options<CreateTodoV1Data, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CreateTodoV1Responses, CreateTodoV1Errors, ThrowOnError>({
        requestValidator: async (data) => {
            return await zCreateTodoV1Data.parseAsync(data);
        },
        responseValidator: async (data) => {
            return await zCreateTodoV1Response.parseAsync(data);
        },
        url: '/api/v1/todos',
        ...options,
        headers: {
...
export const deleteTodoV1 = <ThrowOnError extends boolean = true>(options: Options<DeleteTodoV1Data, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteTodoV1Responses, DeleteTodoV1Errors, ThrowOnError>({
        requestValidator: async (data) => {
            return await zDeleteTodoV1Data.parseAsync(data);
        },
...
export const getTodosV12 = <ThrowOnError extends boolean = true>(options: Options<GetTodosV12Data, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetTodosV12Responses, GetTodosV12Errors, ThrowOnError>({
        requestValidator: async (data) => {
            return await zGetTodosV12Data.parseAsync(data);
        },
        responseValidator: async (data) => {
            return await zGetTodosV12Response.parseAsync(data);
        },
        url: '/api/v1/todos/{todoUuid}',
        ...options
    });
...
export const updateTodoV1 = <ThrowOnError extends boolean = true>(options: Options<UpdateTodoV1Data, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<UpdateTodoV1Responses, UpdateTodoV1Errors, ThrowOnError>({
        requestValidator: async (data) => {
            return await zUpdateTodoV1Data.parseAsync(data);
        },
        url: '/api/v1/todos/{todoUuid}',
        ...options,
        headers: {
...
export const checkTodoV1 = <ThrowOnError extends boolean = true>(options: Options<CheckTodoV1Data, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CheckTodoV1Responses, CheckTodoV1Errors, ThrowOnError>({
        requestValidator: async (data) => {
            return await zCheckTodoV1Data.parseAsync(data);
        },
...
export const uncheckTodoV1 = <ThrowOnError extends boolean = true>(options: Options<UncheckTodoV1Data, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<UncheckTodoV1Responses, UncheckTodoV1Errors, ThrowOnError>({
        requestValidator: async (data) => {
            return await zUncheckTodoV1Data.parseAsync(data);
        },
