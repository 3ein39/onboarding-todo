...
export const icons = {
  ...
  todoCalendar: import('./TodoCalendarIcon.vue'),
  todoChecked: import('./TodoCheckedIcon.vue'),
  todoClock: import('./TodoClockIcon.vue'),
  todoMenuDots: import('./TodoMenuDotsIcon.vue'),
  todoUnchecked: import('./TodoUncheckedIcon.vue'),
