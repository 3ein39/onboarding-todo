...
test.skip('should navigate to contact detail page when clicking on an entry in the overview table', async ({
  http,
  page,
  worker,
}) => {
...
test.skip('should navigate to create page when pressing the create button', async ({
  http,
  page,
  worker,
}) => {
